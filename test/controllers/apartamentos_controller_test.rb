...
class ApartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartamento" do
    assert_difference('Apartamento.count') do
      post apartamentos_url, params: { apartamento: { codApto: @apartamento.codApto, codInquilino: @apartamento.codInquilino, codProprietario: @apartamento.codProprietario, estadoOcupacao: @apartamento.estadoOcupacao, numeroApto: @apartamento.numeroApto } }
    end
  ...
  test "should update apartamento" do
    patch apartamento_url(@apartamento), params: { apartamento: { codApto: @apartamento.codApto, codInquilino: @apartamento.codInquilino, codProprietario: @apartamento.codProprietario, estadoOcupacao: @apartamento.estadoOcupacao, numeroApto: @apartamento.numeroApto } }
